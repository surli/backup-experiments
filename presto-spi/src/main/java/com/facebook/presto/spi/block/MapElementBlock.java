        ...
        extends AbstractMapElementBlock
{
    ...
    public MapElementBlock(int offset, int positionCount, Block keyBlock, Block valueBlock, int[] hashTable, Type keyType, MethodHandle keyNativeHashCode, MethodHandle keyBlockNativeEquals)
    {
    ...
    public int getSizeInBytes()
    {
        return intSaturatedCast(keyBlock.getRegionSizeInBytes(offset / 2, positionCount / 2) +
                ...
                SizeOf.sizeOfIntArray(positionCount / 2 * HASH_MULTIPLIER));
    }

    @Override
    public int getRetainedSizeInBytes()
    {
        return INSTANCE_SIZE + keyBlock.getRetainedSizeInBytes() + valueBlock.getRetainedSizeInBytes();
    }
    ...
    // The next 5 seekKeyExact functions are the same as seekKey (the function above)
