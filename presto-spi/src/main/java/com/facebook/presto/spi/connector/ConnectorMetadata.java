...
public interface ConnectorMetadata
{
     ...
     * If the returned layout list is not empty, at least one of the returned layout must satisfy the following rules, otherwise an exception will be thrown by the caller.
     * <ul>
     * <li>the returned layout either does not contain any columns</li>
     * <li>or if the desiredColumns is provided and is an empty list, the returned layout must contain an empty column list</li>
     * <li>or if the desiredColumns is provided and is not empty, the returned layout must contains all required columns</li>
