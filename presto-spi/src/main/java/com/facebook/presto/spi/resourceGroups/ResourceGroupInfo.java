...
public class ResourceGroupInfo
{
    ...
    {
        this(id, softMemoryLimit, maxRunningQueries, maxQueuedQueries, state, numEligibleSubGroups, memoryUsage, numAggregatedQueuedQueries, numAggregatedRunningQueries, emptyList());
    }
