        ...
        implements ColumnWriter
{
            ...
            throws IOException
    {
        ...
        for (int i = 0; i < rowGroupColumnStatistics.size(); i++) {
            ...
            List<Integer> positions = createDecimalColumnPositionList(compression, dataCheckpoint, scaleCheckpoint, presentCheckpoint);
            ...
            Optional<BooleanStreamCheckpoint> presentCheckpoint)
    {
        ...
        positionList.addAll(scaleCheckpoint.toPositionList(compressionKind));
