        ...
        implements ColumnWriter
{
    ...
    private void writeColumnarMap(ColumnarMap columnarMap)
    {
        ...
        for (int position = 0; position < columnarMap.getPositionCount(); position++) {
            ...
            if (present) {
                nonNullValueCount++;
                lengthStream.writeLong(columnarMap.getLength(position));
            }
        }
        ...
        if (keysBlock.getPositionCount() > 0) {
            ...
            valueWriter.writeBlock(columnarMap.getNullSuppressedValuesBlock());
        }
    }
            ...
            throws IOException
    {
        ...
        for (int i = 0; i < rowGroupColumnStatistics.size(); i++) {
            ...
            List<Integer> positions = createArrayColumnPositionList(compression, lengthCheckpoint, presentCheckpoint);
            ...
            Optional<BooleanStreamCheckpoint> presentCheckpoint)
    {
        ...
        positionList.addAll(lengthCheckpoint.toPositionList(compressionKind));
