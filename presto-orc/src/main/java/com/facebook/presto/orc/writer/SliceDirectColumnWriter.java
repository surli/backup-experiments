        ...
        implements ColumnWriter
{
            ...
            throws IOException
    {
        ...
        for (int i = 0; i < rowGroupColumnStatistics.size(); i++) {
            ...
            List<Integer> positions = createSliceColumnPositionList(compression, lengthCheckpoint, dataCheckpoint, presentCheckpoint);
            ...
            Optional<BooleanStreamCheckpoint> presentCheckpoint)
    {
        ...
        positionList.addAll(dataCheckpoint.toPositionList(compressionKind));
