        ...
        for (Format format : formats) {
            ...
            for (CompressionKind compression : compressions) {
                ...
                try (TempFile tempFile = new TempFile()) {
                    ...
                    assertFileContentsNew(type, tempFile, readValues, false, false, metadataReader);
                }
...
//                    }
                    ...
                    if (skipBatchTestsEnabled) {
                        assertFileContentsNew(type, tempFile, readValues, true, false, metadataReader);
                    }

                    if (skipStripeTestsEnabled) {
                        assertFileContentsNew(type, tempFile, readValues, false, true, metadataReader);
                    }
                }
            }
        }
            ...
            throws IOException
    {
        ...
        OrcReader orcReader = new OrcReader(orcDataSource, metadataReader, new DataSize(1, MEGABYTE), new DataSize(1, MEGABYTE));
    ...
    private static Object decodeRecordReaderValue(Type type, Object actualValue)
    {
        ...
        if (actualValue instanceof BooleanWritable) {
            ...
            actualValue = (int) ((ByteWritable) actualValue).get();
        }
            ...
            actualValue = (int) ((ShortWritable) actualValue).get();
        }
