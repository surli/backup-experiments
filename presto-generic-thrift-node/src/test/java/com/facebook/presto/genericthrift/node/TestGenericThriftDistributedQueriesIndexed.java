...
public class TestGenericThriftDistributedQueriesIndexed
        extends AbstractTestIndexedQueries
{
    ...
    public TestGenericThriftDistributedQueriesIndexed()
            throws Exception
    {
        this(startThriftServers(DEFAULT_THRIFT_NODES_COUNT));
    }

    public TestGenericThriftDistributedQueriesIndexed(List<ThriftServer> servers)
            throws Exception
    {
