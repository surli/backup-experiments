...
public interface MongoOperations extends FluentMongoOperations {
	 ...
	 * @since 2.1
	 */
	default <S, T> List<T> findDistinct(String field, Class<S> entityClass, Class<T> resultClass) {
	 ...
	 * @since 2.1
	 */
	<S, T> List<T> findDistinct(Query query, String field, Class<S> entityClass, Class<T> resultClass);
	 ...
	 * @since 2.1
	 */
	<S, T> List<T> findDistinct(Query query, String field, String collectionName, Class<S> entityClass,
			Class<T> resultClass);
