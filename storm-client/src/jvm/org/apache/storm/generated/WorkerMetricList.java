...
public class WorkerMetricList implements org.apache.thrift.TBase<WorkerMetricList, WorkerMetricList._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerMetricList> {
  ...
  private List<WorkerMetricFields> metrics; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.METRICS, new org.apache.thrift.meta_data.FieldMetaData("metrics", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, WorkerMetricFields.class))));
  ...
  public WorkerMetricList(
    List<WorkerMetricFields> metrics)
  {
    this();
  ...
  public WorkerMetricList(WorkerMetricList other) {
    if (other.is_set_metrics()) {
      List<WorkerMetricFields> __this__metrics = new ArrayList<WorkerMetricFields>(other.metrics.size());
      for (WorkerMetricFields other_element : other.metrics) {
        __this__metrics.add(new WorkerMetricFields(other_element));
      }
  ...
  public java.util.Iterator<WorkerMetricFields> get_metrics_iterator() {
    return (this.metrics == null) ? null : this.metrics.iterator();
  }

  public void add_to_metrics(WorkerMetricFields elem) {
    if (this.metrics == null) {
      this.metrics = new ArrayList<WorkerMetricFields>();
    }
    this.metrics.add(elem);
  }

  public List<WorkerMetricFields> get_metrics() {
    return this.metrics;
  }

  public void set_metrics(List<WorkerMetricFields> metrics) {
    this.metrics = metrics;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case METRICS:
      if (value == null) {
        ...
        set_metrics((List<WorkerMetricFields>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metrics = new ArrayList<WorkerMetricFields>(_list886.size);
                WorkerMetricFields _elem887;
                for (int _i888 = 0; _i888 < _list886.size; ++_i888)
                {
                  _elem887 = new WorkerMetricFields();
                  _elem887.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorkerMetricList struct) throws org.apache.thrift.TException {
      ...
      if (struct.metrics != null) {
        oprot.writeFieldBegin(METRICS_FIELD_DESC);
        {
          ...
          for (WorkerMetricFields _iter889 : struct.metrics)
          {
      ...
      if (struct.is_set_metrics()) {
        {
          ...
          for (WorkerMetricFields _iter890 : struct.metrics)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.metrics = new ArrayList<WorkerMetricFields>(_list891.size);
          WorkerMetricFields _elem892;
          for (int _i893 = 0; _i893 < _list891.size; ++_i893)
          {
            _elem892 = new WorkerMetricFields();
            _elem892.read(iprot);
