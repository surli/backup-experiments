...
class TestPutDatabaseRecord {
    ...
    private static final String createPersons = "CREATE TABLE PERSONS (id integer primary key, name varchar(100), code integer CONSTRAINT CODE_RANGE CHECK (code >= 0 AND code < 1000))"
