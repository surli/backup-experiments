...
public class TestSqlParser
{
            ...
            throws Exception
    {
        ...
        assertInvalidExpression("u&'\u6d4B\u8Bd5ABC\\'", "Incomplete escaped sequence: ");
        assertInvalidExpression("u&'\u6d4B\u8Bd5ABC\\+'", "Incomplete escaped sequence: ");
        assertInvalidExpression("U&'hello\\6dB\\8Bd5'", "Incomplete escaped sequence: 6dB.*");
        assertInvalidExpression("U&'hello\\6D4B\\8Bd'", "Incomplete escaped sequence: 8Bd");
        assertInvalidExpression("U&'hello\\6KB\\8Bd5'", "Invalid hexadecimal digit: K");
