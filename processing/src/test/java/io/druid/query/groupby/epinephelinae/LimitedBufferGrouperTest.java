...
public class LimitedBufferGrouperTest
{
  ...
  public void testLimitAndBufferSwapping()
  {
    ...
    final LimitedBufferGrouper<Integer> grouper = makeGrouper(columnSelectorFactory, 10000, 2, limit);
  ...
  public void testMinBufferSize()
  {
    ...
    final int keyBase = 100000;
    final TestColumnSelectorFactory columnSelectorFactory = GrouperTestUtil.newColumnSelectorFactory();
    final LimitedBufferGrouper<Integer> grouper = makeGrouper(columnSelectorFactory, 6060, 2, limit);
    final int numRows = 1000;
  ...
  {
    return new LimitedBufferGrouper<>(
