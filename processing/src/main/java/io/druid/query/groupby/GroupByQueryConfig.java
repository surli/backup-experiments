...
public class GroupByQueryConfig
{
  ...
  public static final String CTX_KEY_PUSH_DOWN_LIMIT = "pushDownLimit";
  ...
  @JsonProperty
  private boolean pushDownLimit = false;
  ...
  public boolean isPushDownLimit() {
  ...
  public GroupByQueryConfig withOverrides(final GroupByQuery query)
  {
    ...
    newConfig.pushDownLimit = query.getContextBoolean(CTX_KEY_PUSH_DOWN_LIMIT, isPushDownLimit());
    return newConfig;
  }
}
