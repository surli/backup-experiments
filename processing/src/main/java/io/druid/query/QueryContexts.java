...
public class QueryContexts
{
  ...
  public static <T> Query<T> withStartTime(Query<T> query, long startTimeMillis)
  {
    return query.withOverriddenContext(ImmutableMap.of(START_TIME_KEY, startTimeMillis));
  }

  public static <T> long getTimeoutLeft(Query<T> query)
  {
    long startTime = parseLong(query, START_TIME_KEY, 0);
