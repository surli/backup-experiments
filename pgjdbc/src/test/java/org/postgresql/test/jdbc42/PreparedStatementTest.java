...
public class PreparedStatementTest extends BaseTest4 {
  ...
  public void test2400() throws SQLException {
    ...
    Assert.assertEquals(LocalTime.MIDNIGHT, localTime);
    //subtract 86,400,000 because the "day" read is Jan 1 rather than Jan 2.
    Assert.assertEquals(gmtPoint - 86400000, rs.getTime(1, gmtCal).getTime());
    Assert.assertEquals(cstPoint - 86400000, rs.getTime(1, cstCal).getTime());
