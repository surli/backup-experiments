...
public class PgStatement implements Statement, BaseStatement {
  ...
  protected final AtomicReferenceFieldUpdater<PgStatement, Boolean> IS_CLOSED =
      AtomicReferenceFieldUpdater.newUpdater(PgStatement.class, Boolean.class, "isClosed");
  ...
  public final void close() throws SQLException {
    ...
    if (!IS_CLOSED.compareAndSet(this, Boolean.FALSE, Boolean.TRUE)) {
      return;
    }
