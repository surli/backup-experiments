        ...
        extends AbstractTestFunctions
{
    ...
    public void testEmpty()
            throws Exception
    {
        assertFunction("map_filter(map(ARRAY[], ARRAY[]), (k, v) -> true)", mapType(UNKNOWN, UNKNOWN), of());
        assertFunction("map_filter(map(ARRAY[], ARRAY[]), (k, v) -> false)", mapType(UNKNOWN, UNKNOWN), of());
        assertFunction("map_filter(map(ARRAY[], ARRAY[]), (k, v) -> CAST (NULL AS BOOLEAN))", mapType(UNKNOWN, UNKNOWN), of());
        assertFunction("map_filter(CAST (map(ARRAY[], ARRAY[]) AS MAP(BIGINT,VARCHAR)), (k, v) -> true)", mapType(BIGINT, VARCHAR), of());
    }
            ...
            throws Exception
    {
        ...
        assertFunction("map_filter(map(ARRAY[1], ARRAY [NULL]), (k, v) -> v IS NOT NULL)", mapType(INTEGER, UNKNOWN), of());
        ...
        assertFunction("map_filter(map(ARRAY[1, 2, 3], ARRAY [NULL, NULL, NULL]), (k, v) -> v IS NOT NULL)", mapType(INTEGER, UNKNOWN), of());
    }
            ...
            throws Exception
    {
        ...
        assertFunction(
                ...
                of(25, ImmutableList.of("a", "b"), 27, ImmutableList.of("a", "b", "c")));
        ...
        assertFunction(
                ...
                of(25.5, ImmutableList.of("a", "b"), 27.5, ImmutableList.of("a", "b", "c")));
        ...
        assertFunction(
                ...
                of(true, ImmutableList.of("a", "b"), false, ImmutableList.of("a", "b", "c")));
        ...
        assertFunction(
                ...
                of("s0", ImmutableList.of("a", "b"), "s2", ImmutableList.of("a", "b", "c")));
        ...
        assertFunction(
                ...
                of(ImmutableList.of(1, 2), 25, ImmutableList.of(), 27));
        assertFunction(
                ...
                of(ImmutableList.of(1, 2), 25.5, ImmutableList.of(), 27.5));
        assertFunction(
                ...
                of(ImmutableList.of(1, 2), false, ImmutableList.of(), true));
        assertFunction(
                ...
                of(ImmutableList.of(1, 2), "abc", ImmutableList.of(), "xyz"));
        assertFunction(
                ...
                of(ImmutableList.of(3, 4), ImmutableList.of("a", "b", "c"), ImmutableList.of(), ImmutableList.of("a", "c")));
    }
}
