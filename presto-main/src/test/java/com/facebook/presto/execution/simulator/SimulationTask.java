...
abstract class SimulationTask
{
    ...
    SimulationTask(TaskExecutor taskExecutor, TaskSpecification specification, TaskId taskId)
    {
    ...
    static class LeafTask
            extends SimulationTask
    {
        private final SplitSpecification splitSpecification;

        public LeafTask(TaskExecutor taskExecutor, TaskSpecification specification, TaskId taskId, SplitSpecification splitSpecification)
        {
    ...
    static class IntermediateTask
            extends SimulationTask
    {
        private final SplitSpecification splitSpecification;

        public IntermediateTask(TaskExecutor taskExecutor, TaskSpecification specification, TaskId taskId, SplitSpecification splitSpecification)
        {
            super(taskExecutor, specification, taskId);
            this.splitSpecification = splitSpecification;
        }
