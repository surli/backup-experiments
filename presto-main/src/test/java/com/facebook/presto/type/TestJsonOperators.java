        ...
        extends AbstractTestFunctions
{
    ...
    public void testCastFromMap()
    {
        ...
        // Test key types
        assertFunction("CAST(MAP(ARRAY[true, false], ARRAY[1, 2]) AS JSON)", JSON, "{\"true\":1,\"false\":2}");
        ...
        assertFunction(
                ...
                JSON,
                "{\"12345678901234567890.1234567890666666\":666666,\"0E-16\":null}");
        ...
        assertFunction(
                ...
                JSON,
                "{\"1\":3.14,\"2\":1.0E-323,\"3\":1.0E308,\"5\":\"NaN\",\"8\":\"Infinity\",\"13\":\"-Infinity\",\"21\":null}");
        ...
        assertFunction(
                ...
                JSON,
                "{\"1\":123,\"2\":3.14,\"3\":false,\"5\":\"abc\",\"8\":[1,\"a\",null],\"13\":{\"a\":1,\"b\":\"str\",\"c\":null},\"21\":null,\"34\":null}");
        ...
        assertFunction(
                ...
                JSON,
                "{\"1\":{\"a\":1,\"b\":2},\"2\":{\"three\":3,\"none\":null},\"3\":{},\"5\":{\"h1\":null,\"h2\":null},\"8\":null}");
        assertFunction(
