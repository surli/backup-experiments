        ...
        implements SourceOperator, Closeable
{
            ...
            implements SourceOperatorFactory
    {
        ...
        public SourceOperator createOperator(DriverContext driverContext)
        {
            ...
            return new MergeOperator(
                    ...
                    orderingCompiler.compileMergeSortComparator(sortTypes(sourceTypes, sortChannels), sortChannels, sortOrder),
                    outputChannels,
                    outputTypes);
        }
    ...
    {
        ImmutableList.Builder<PageSupplier> pageSuppliers = ImmutableList.builder();
        ...
        mergeSortProcessor = new MergeSortProcessor(comparator, pageSuppliers.build());
    ...
    {
        checkState(mergeSortProcessor != null, "mergeSources must be non-null when getting input");
        ...
        while (!pageBuilder.isFull()) {
            PageWithPosition pageWithPosition = mergeSortProcessor.poolNextRow();
