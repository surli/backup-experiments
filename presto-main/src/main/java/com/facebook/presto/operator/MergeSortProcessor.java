...
public class MergeSortProcessor
{
    ...
    public MergeSortProcessor(MergeSortComparator comparator, List<PageSupplier> pageSuppliers)
    {
    ...
    @Nullable
    public PageWithPosition poolNextRow()
    {
    ...
    private static class MergeSource
    {
        ...
        public PageWithPosition getPage()
        {
            ...
            Page page = pageSupplier.poolPage();
