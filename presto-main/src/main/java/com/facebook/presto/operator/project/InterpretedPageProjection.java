        ...
        implements PageProjection
{
            ...
            implements PageProjectionOutput
    {
        ...
        public Optional<Block> compute()
        {
            ...
            if (positions != null) {
                for (int index = nextIndexOrPosition; index < length; index++) {
                    if (!project(positions[index])) {
                        nextIndexOrPosition = index + 1;
                        break;
                    }
                }
            }
            else {
                for (int position = nextIndexOrPosition; position < length; position++) {
                    if (!project(position)) {
                        nextIndexOrPosition = position + 1;
                        break;
                    }
                }
            }
        ...
        private boolean project(int position)
        {
