        ...
        extends SqlScalarFunction
{
    ...
    public ScalarFunctionImplementation specialize(BoundVariables boundVariables, int arity, TypeManager typeManager, FunctionRegistry functionRegistry)
    {
        ...
        return new ScalarFunctionImplementation(false, ImmutableList.of(false, false), ImmutableList.of(false, false), METHOD_HANDLE.bindTo(mapType).bindTo(keyHashCode).bindTo(keyEqual), Optional.of(instanceFactory), isDeterministic());
    }

    @UsedByGeneratedCode
    public static Block createMap(MapType mapType, MethodHandle keyHashCode, MethodHandle keyEqual, State state, Block keyBlock, Block valueBlock)
    {
        PageBuilder pageBuilder = state.pageBuilder;
