...
import static com.facebook.presto.util.JsonUtil.FieldNameProvider;
        ...
        extends SqlOperator
{
    ...
    private static final MethodHandle METHOD_HANDLE = methodHandle(MapToJsonCast.class, "toJson",  FieldNameProvider.class, JsonGeneratorWriter.class, ConnectorSession.class, Block.class);
    ...
    public ScalarFunctionImplementation specialize(BoundVariables boundVariables, int arity, TypeManager typeManager, FunctionRegistry functionRegistry)
    {
        ...
        FieldNameProvider provider = FieldNameProvider.createFieldNameProvider(keyType);
    ...
    @UsedByGeneratedCode
    public static Slice toJson(FieldNameProvider provider, JsonGeneratorWriter writer, ConnectorSession session, Block block)
    {
        try {
            Map<String, Integer> orderedKeyToValuePosition = new TreeMap<>();
            for (int i = 0; i < block.getPositionCount(); i += 2) {
                String objectKey = provider.getFieldName(block, i);
