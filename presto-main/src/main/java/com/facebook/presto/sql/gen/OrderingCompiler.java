...
public class OrderingCompiler
{
    ...
    @VisibleForTesting
    public MergeSortComparator internalCompileMergeSortComparator(List<Type> sortTypes, List<Integer> sortChannels, List<SortOrder> sortOrders)
    {
        MergeSortComparator comparator;
        try {
            Class<? extends MergeSortComparator> mergeSortComparatorClass = generateMergeSortComparatorClass(sortTypes, sortChannels, sortOrders);
            ...
            comparator = new SimpleMergeSortComparator(sortTypes, sortChannels, sortOrders);
        }
        return comparator;
    }
