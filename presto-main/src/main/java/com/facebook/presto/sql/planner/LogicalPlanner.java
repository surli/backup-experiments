...
public class LogicalPlanner
{
    ...
    private RelationPlan createTableCreationPlan(Analysis analysis, Query query)
    {
        ...
        ConnectorTableMetadata tableMetadata = createTableMetadata(destination, getOutputTableColumns(plan), analysis.getCreateTableProperties(), analysis.getParameters(), analysis.getComment());
