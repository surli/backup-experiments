...
public final class FieldId
{
    public static FieldId from(ResolvedField resolvedField)
    {
        ...
        return new FieldId(sourceScope.getScopeId(), relationType.indexOf(resolvedField.getField()));
    }

    private final ScopeId scopeId;
    private final int fieldIndexInRelationType;

    public FieldId(ScopeId scopeId, int fieldIndexInRelationType)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        return fieldIndexInRelationType == fieldId.fieldIndexInRelationType &&
                Objects.equals(scopeId, fieldId.scopeId);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(scopeId, fieldIndexInRelationType);
    }
