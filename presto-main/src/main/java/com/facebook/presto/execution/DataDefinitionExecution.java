        ...
        implements QueryExecution
{
            ...
            implements QueryExecutionFactory<DataDefinitionExecution<?>>
    {
                ...
                WarningSink warningSink)
        {
            ...
            QueryStateMachine stateMachine = QueryStateMachine.begin(queryId, query, session, self, task.isTransactionControl(), transactionManager, accessControl, executor, metadata, warningSink);
