...
public class MailTest {
    ...
    public void testHelloWorld() throws IOException {
        ...
        content.setType(ContentType.TEXT_PLAIN);
        content.setValue("some text here");
        mail.addContent(content);
        content.setType(ContentType.TEXT_HTML);
    ...
    public void testKitchenSink() throws IOException {
        ...
        attachments.setType(ContentType.APPLICATION_PDF);
        ...
        attachments2.setType(ContentType.IMAGE_PNG);
