 ...
 */
final class ComplexGeoJsonWriter {
    ...
    ComplexGeoJsonWriter(GeoJSONBuilder jsonWriter) {
     ...
     */
    private void encodeSimpleContentAttribute(Attribute attribute) {
        String name = attribute.getName().getLocalPart();
    ...
    /**
     * Return TRUE fi a geometry was found during the features collections encoding.
     */
